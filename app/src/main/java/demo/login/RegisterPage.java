	...
	public void onClick(View v) {
		...
		case R.id.tv_ensure:
			...
			if (registerListener.onRegister(userInfo)) {
				...
				//finish();
				Cursor c = MyDBHelper.getInstances(this).query1();
				if (c.moveToFirst()) {
					MyDBHelper.getInstances(this).updata1(1,userInfo.getUserName(),picturePath);
				}else {
					MyDBHelper.getInstances(this).insert1(userInfo.getUserName(),picturePath);
				}
